...
const NavBar = async () => {
  ...
  return (
    <nav className="sticky top-0 z-50 flex justify-between items-center px-4 md:px-10 py-3 bg-[#FAFBF6] shadow-md">
      ...
      <Link href="/" className="flex items-center gap-2">
        ...
        <h1 className="text-2xl font-bold text-[#03497F] hidden md:flex">
